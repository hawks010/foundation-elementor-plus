...
class Portfolio_Mega_Menu_Widget extends Base_Widget {
	public function get_name() {
		return 'foundation-portfolio-mega-menu';
	}

	public function get_title() {
		return esc_html__( 'Portfolio Menu', 'foundation-elementor-plus' );
	}
	...
	public function get_style_depends(): array {
		return $this->get_foundation_style_depends( array( 'foundation-elementor-plus-portfolio-mega-menu' ) );
	}
	...
	protected function render() {
		...
		?>
		<section <?php echo $this->get_widget_root_attributes( $settings, array( 'id' => $widget_id, 'class' => 'foundation-portfolio-mega-menu', 'data-foundation-portfolio-mega-menu' => true ) ); ?>>
